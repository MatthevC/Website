...
function emotes7tvPage() {
  const steps = [
    ["01","ZAINSTALUJ ROZSZERZENIE","Zacznij od BetterTTV — to najwygodniejsza opcja.",`Wejdź na <a href="https://betterttv.com/" target="_blank" rel="noopener"><strong>BetterTTV ↗</strong></a> i dodaj rozszerzenie do swojej przeglądarki. BetterTTV obsługuje również 7TV i FrankerFaceZ — masz więc trzy systemy w jednym miejscu.`,"pictures/emotes7tv/step-3.png","Instalacja BetterTTV — ekran rozszerzenia"],
